    ...
    <div class="container-fluid">
      <div class="side-body">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <legend><h1><small><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Stok Barang Paket</small></h1></legend>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php 
                          for($i = 0; $i < $jumlah_total_barang; $i++) {
                            ...
                            $id = 'id-'. $i;
                            $url = base_url('index.php/admin/stok_barang_paket/submit_edit_barang_paket');
                                  ...
                                  <div class='modal-content'>
                                    ...
                                    <form action='$url' method='POST' class='form-horizontal' role='form' enctype='multipart/form-data' 
                                     ...
                                     <div class='modal-body'>
                                                <input type='hidden' name='id-barang' value='". $item['id_barang_paket'] ."'/>
                                                  <div class='container-fluid'>
  ...
  <script type="text/javascript">
    $(function() {
        var table = $('#table').DataTable({ 
              ...
              "ajax": {
                  "url": "<?php echo base_url() .'index.php/admin/stok_barang_paket/ajax_list_stok_barang_paket'; ?>",
                  "type": "POST"
              },
                ...
                $('.brg-delete').on('click',function(){
                  ...
                  swal({
                    ...
                    function(isConfirm){
                      if (isConfirm) {
                        $.ajax({
                          url: "<?php echo base_url('index.php/admin/stok_barang_paket/ajax_delete_barang_paket'); ?>",
                          type: "POST",
                          dataType:'json',
                          data: {id: idBarang},
                          success: function() {              
