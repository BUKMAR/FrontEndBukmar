        ...
        <ul class="nav navbar-nav">
            ...
            <li class="panel panel-default" id="dropdown">
                ...
                <div id="dropdown-lvl1" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul class="nav navbar-nav">
                            <li><a href="<?php echo base_url(); ?>index.php/member/status_komisi">Status Komisi</a></li>
                            <li><a href="<?php echo base_url(); ?>index.php/member/history_bonus">History Bonus</a></li>
                        </ul>
                    </div>
                </div>
            </li>
            ...
            <li><a href="<?php echo base_url(); ?>index.php/member/logout"><span class="glyphicon glyphicon-off"></span> Lougout</a></li>
